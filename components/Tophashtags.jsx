        ...
        <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
          ...
          <div className="p-2 sm:w-1/2 w-full">
            <div className="bg-gray-100 rounded flex p-4 h-full items-center space-x-4">
              ...
              <p className="title-font font-medium">Kinfolk Chips Snackwave</p>
            </div>
          </div>
          <div className="p-2 sm:w-1/2 w-full">
            <div className="bg-gray-100 rounded flex p-4 h-full items-center space-x-4">
              ...
              <p className="title-font font-medium">Coloring Book Ethical</p>
            </div>
          </div>
          <div className="p-2 sm:w-1/2 w-full">
            <div className="bg-gray-100 rounded flex p-4 h-full items-center space-x-4">
              ...
              <p className="title-font font-medium">Typewriter Polaroid Cray</p>
            </div>
          </div>
          <div className="p-2 sm:w-1/2 w-full">
            <div className="bg-gray-100 rounded flex p-4 h-full items-center space-x-4">
