  ...
  return (
    <section className="text-gray-600 body-font font-Quicksand">
      <div className="container px-5 py-24 mx-auto flex flex-col">
        <div className="lg:w-4/6 mx-auto border">
        ...
        <div className="lg:w-4/6 mx-auto my-10 border">
          <div className="w-full ">
            <ul className="w-full flex border-r justify-evenly  ">
              <li className=" hover:bg-black  hover:text-white hover:cursor-pointer py-6 text-lg  w-full text-center  hover:font-semibold transition-all">
                My Talks
              </li>
              <li className=" hover:bg-black  hover:text-white hover:cursor-pointer py-6 text-lg  w-full text-center  hover:font-semibold transition-all">
                My Answers
